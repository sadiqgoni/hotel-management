<x-filament-panels::page>
    ...
    <div class="my-4">
        <x-filament::button wire:click="toggleHistory" class="mb-4">
            {{ $showHistory ? 'Hide Check-out History' : 'Show Check-out History' }}
        </x-filament::button>
        ...
        @if ($showHistory)
            <div id="checkOutHistoryTable" class="mt-4">
                <h2 class="text-lg font-semibold mb-4">Check Out History</h2>
                {{ $this->table }}
            </div>
        @endif
